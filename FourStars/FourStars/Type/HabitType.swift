...
enum MorningHabitType: String, CaseIterable, Identifiable, Codable, HabitTypeProtocol {
    case drinkWater = "물"
    case wakeUp = "기상"
    case stretch = "스트레칭"
...
enum AfternoonHabitType: String, CaseIterable, Identifiable, Codable, HabitTypeProtocol {
    case walk = "산책"
    case read = "책"
    case meditate = "명상"
